...
window.OS_EXAMPLES = [
  ...
  { title: "Open-letter signatory",
    msg: "I'm one of the people who helped draft today's open letter. I stand by every word, but signing it openly would obviously cost me my job.",
  ...
  { title: "Out-of-process bans",
    ...
    about: "A moderator alleging that a ban was made dishonestly.",
    members: [
      { name: "velvetnoise" },
